      ...
      for (b = 0; b < f.length; b += 1) {
        ...
        var g =
          (a =
            ...
            f[b].getAttributeNS('http://www.w3.org/1999/xlink', 'href') ||
        ...
        g = g[1];
        var r =
          h && 0 === h.left && 0 === h.right && 0 === h.top && 0 === h.bottom;
        h && 0 === h.width && 0 === h.height && !r
          ? (c.length || !g || document.getElementById(g) || (c = ''),
            ...
            c.length &&
              ((a = e[c]),
              !0 !== a && setTimeout(l({ useEl: f[b], base: c, hash: g }), 0),
              void 0 === a &&
                ((g = u(c)),
                void 0 !== g &&
                  ((a = new g()),
          ...
          : void 0 === e[c]
          ? (e[c] = !0)
          : e[c].onload && (e[c].abort(), delete e[c].onload, (e[c] = !0));
      }
      f = '';
      q += 1;
      d();
